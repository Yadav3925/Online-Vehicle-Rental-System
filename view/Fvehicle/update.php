...
<center><h1>Update Vehcile Details</h1><center>
 ...
 <center><h3>Update Vehcile</h3><center>
   <form method="POST" action="Fvehicle/UpdateData">
   <?php  
  ...
  <div class="row mb-4">
    <div class="col">
      <div class="form-outline">
      <label class="form-label" for="scapacity">Seating Capacity</label>
  ...
  <div class="row mb-4">
    ...
    <div class="col">
      ...
      <label class="form-label" for="Fuel">Fuel</label>
        <input type="text" value="<?php echo $row['Fuel'] ?>" class="form-control" name="fuel" />
    ...
    <div class="col">
      ...
      <label class="form-label" for="Doors">Doors</label>
        ...
        <input type="text" value="<?php echo $row['Doors'] ?>" class="form-control" name="door" />
    ...
    <div class="col">
      ...
      <label class="form-label" for="gear">Gear Box</label>
        <input type="text" value="<?php echo $row['GearBox'] ?>" class="form-control" name="gear" />
