...
h1 {
  ...
  <center><h1> Four Wheeler Between Reports</h1><center>
<div class="col-sm-7" style="border:solid">

<div class="mb-7 row">
<center><h3>Between Date Booking Count</h3><center>
<form method="POST" action="Report/ReportF">
		    <div class="mb-4 row" >
           <label for="from" class="col-sm-2 col-form-label">From Date:-</label>
          <div class="col-sm-8">
               <input type="date" class="form-control form-control-sm" id="from" name="from" class="">
    </div>
  </div>
  <div class="mb-4 row">
